...
#define  named_arg(name) \
  template <typename CURRENT_T, typename T, size_t Index, bool N> \
    ...
    public:\
      ...
      auto name(T x) {\
        return typename CURRENT_T::update<Index>::do_update(*m_curr, CONCATENATE(named_arg_, name)<CURRENT_T, T, Index, true>(x));\
      }\
  }; \
  ...
  template <typename CURRENT_T, typename T, size_t Index, bool N> \
    ...
    public:
      ...
      auto date(T x) {
        return  CURRENT_T::update<Index>::do_update(*m_curr, named_arg_date<CURRENT_T, T, Index, true>(x));
      }
  };
  template <typename CURRENT_T, typename T, size_t Index>
...
#define ___ArggLib__test3__Update(Index,...) \
   template <>\
  class update<Index> {\
  public:\
    template <typename T1, typename T2>\
  ...
  public:
    ...
    ___ArggLib__test3__Update(1, true, N2, N3);
    ___ArggLib__test3__Update(2, N1, true, N3);
    ___ArggLib__test3__Update(3, N1, N2, true);
